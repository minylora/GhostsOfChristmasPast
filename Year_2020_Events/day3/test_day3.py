...
@pytest.mark.parametrize("slope_map, right, down, result", how_many_trees_given_slope_data)
def test_how_many_trees_for_single_slope_sample(slope_map, right, down, result, request):
    slope_map = request.getfixturevalue(slope_map)
...
def test_how_many_trees_for_multiple_slopes(slope_map_sample, sample_slopes):
    assert day3.how_many_trees_for_multiple_slopes_multiplied(slope_map_sample, sample_slopes) == 336


def test_how_many_trees_for_multiple_slopes(slope_map_input, sample_slopes):
    assert day3.how_many_trees_for_multiple_slopes_multiplied(slope_map_input, sample_slopes) == 4723283400
